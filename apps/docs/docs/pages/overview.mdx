...
<Callout type="warning">
    Trigger Warning: You might witness terrible hand-drawn diagrams in this page. We apologize in advance. Also, this is a high-level overview and protocol is still in early stages, so expect some details to change as we iterate.
</Callout>
...
- Build something valuable on your slot, and people will pay more to take it.
- Let it sit idle, and the tax eats your deposit until someone else steps in.
- Price it fairly, produce something good, and you keep it — sustainably.
