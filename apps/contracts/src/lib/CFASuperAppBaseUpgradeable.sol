...
import {ISuperfluid, SuperAppDefinitions, IGeneralDistributionAgreementV1} from "@superfluid-finance/ethereum-contracts/contracts/interfaces/superfluid/ISuperfluid.sol";
 ...
 */
abstract contract CFASuperAppBaseUpgradeable is ISuperApp, Initializable {
   ...
   */
  function __CFASuperAppBaseUpgradeable_init(
    ISuperfluid host_
  ...
  function selfRegister(
    ...
    HOST.registerApp(
      getConfigWord(activateOnCreated, activateOnUpdated, activateOnDeleted)
    );
  }
  ...
  function beforeAgreementUpdated(
    ...
    (address sender, ) = abi.decode(agreementData, (address, address));
    (uint256 lastUpdated, int96 flowRate, , ) = superToken.getCFAFlowInfo(
      sender,
      address(this)
    );
  ...
  function afterAgreementUpdated(
    ...
    (address sender, ) = abi.decode(agreementData, (address, address));
    (int96 previousFlowRate, uint256 lastUpdated) = abi.decode(
      cbdata,
      (int96, uint256)
    );
  ...
  function afterAgreementTerminated(
    ...
    (uint256 lastUpdated, int96 previousFlowRate) = abi.decode(
      cbdata,
      (uint256, int96)
    );
