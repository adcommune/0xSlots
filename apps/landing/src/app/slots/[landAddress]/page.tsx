    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b-4 border-black">
        <div className="max-w-6xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div>
              <a href="/slots" className="font-mono text-xs text-gray-500 hover:underline">
                ← AdLand
              </a>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
            ...
            .map((slot: any) => {
              ...
              return (
                <div key={slot.id} className="border-2 border-black">
                  ...
                  >
                    <span className="font-black text-sm">SLOT #{slot.slotId}</span>
                    <span
                  ...
                  <div className="px-4 py-3 space-y-2 font-mono text-xs">
                    {isOccupied && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold">{shorten(slot.occupant)}</span>
                      </div>
                    )}
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>{formatPrice(slot.currency === "0x0000000000000000000000000000000000000000" ? slot.price : slot.price)}</span>
                    </div>
                    <div className="flex justify-between">
        ...
        <div className="mt-8 border-2 border-black p-6">
          <h2 className="font-black text-sm uppercase mb-4">LAND OWNER ACTIONS</h2>
          <SlotActions
            landAddress={land.id}
            slotIndex={-1}
            isOccupied={false}
