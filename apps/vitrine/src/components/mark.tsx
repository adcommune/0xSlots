  ...
  return (
    ...
    >
      <g transform="rotate(45 50 50)">
        ...
        <rect x="22" y="22" width="16" height="16" className="fill-paper" />
        <rect x="42" y="22" width="16" height="16" className="fill-paper" />
        <rect x="22" y="42" width="16" height="16" className="fill-paper" />
        <rect x="42" y="42" width="16" height="16" className="fill-paper" />
      </g>
    </svg>
  );
}
